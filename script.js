        ...
        .then(
            (data1) => {
                ...
                for (var i = 0; i < data1.length; i++) {
                    console.log(`name:${data1[i].name} flag :${data1[i].flags.svg} capital: ${data1[i].capital} region: ${data1[i].region} counrtycode: ${data1[i].callingCodes[0]} latlng:${data1[i].latlng}`)

                   
                    col = createcolumn('card', 'card-title', data1[i].name, "card-img-top", data1[i].flags.svg, `Capital: ${data1[i].capital}`, `Region: ${data1[i].region}`, `Counrtycode: ${data1[i].callingCodes[0]}`
                      );
